...
from app_fca.models import Carreras, Comisiones, Docentes
from app_fca.forms import FormAltaCarrera, FormAltaComisiones, FormAltaDocente, FormReporte, FormReporteCarrera, FormReporteComisiones, FormReporteDni
